...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 13, 2021 at 10:23 AM
...
INSERT INTO `courses` (`id`, `user_id`, `title`, `trainer`, `about`, `publish`, `created_at`, `updated_at`) VALUES
(1, 1, 'Test Course', 'Coleen Camince', 'Course Testing', 0, '2020-08-27 20:14:41', '2020-08-27 20:14:41');
...
(46, '2020_07_24_013029_add_user_level_to_users_table', 1),
(130, '2014_10_12_000000_create_users_table', 2),
(131, '2014_10_12_100000_create_password_resets_table', 2),
(132, '2019_08_19_000000_create_failed_jobs_table', 2),
(133, '2020_07_27_161400_create_courses_table', 2),
(134, '2020_07_28_181751_create_modules_table', 2),
(135, '2020_08_06_212202_create_questions_table', 2),
(136, '2020_08_06_212219_create_choices_table', 2),
(137, '2020_08_12_022031_student_course', 2),
(138, '2020_08_19_012312_module_user', 2),
(139, '2020_08_21_155025_create_appointments_table', 2),
(140, '2020_08_25_062543_create_answers_table', 2),
(141, '2020_08_28_035509_exam_user', 2);
...
(1, 'Coleen Camince', 'coleen@gmail.com', 1, NULL, NULL, '$2y$10$oyvqv0dYVIqCXCFvDlXB5euLOHzBUo44ClVCdgrpeWeSDs7wZXtRC', NULL, '2020-08-27 20:13:55', '2020-08-27 20:13:55');
...
ALTER TABLE `exam_user`
  ...
  ADD KEY `exam_user_course_id_foreign` (`course_id`);
...
--
ALTER TABLE `exam_user`
  ADD CONSTRAINT `exam_user_course_id_foreign` FOREIGN KEY (`course_id`) REFERENCES `courses` (`id`) ON DELETE CASCADE,
