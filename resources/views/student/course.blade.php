    ...
    @if($approval->name == Auth::user()->name)
        @if($approval->isApproved)
            <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-8" id="module_video">
...
<script type="text/javascript">
    function moduleFunction(module_name, module_video, module_id){
        if (document.getElementById('moduleID').value != module_id) {
            ...
            document.getElementById('module_video').innerHTML = "<video width='100%' controls=''><source src='/storage/{{$course->trainer}}/{{$course->id}}/"+module_video+"' type='video/mp4'></video>";
